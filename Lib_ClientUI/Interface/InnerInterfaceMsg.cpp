...
//#include "BasicVarTextBoxEx.h"//itemmall


/*New Character Window | PageWear */
...
//				#endif
	...
	case NPC_ITEM_EXCHANGE_WINDOW:	/*item exchange, Juver, 2017/10/12 */
		{			
			BOOL bSnap = (dwMsg & UIMSG_MOUSEIN_WEARSLOT) || (dwMsg & UIMSG_MOUSEIN_ITEMSLOT);//BOOL bSnap = (dwMsg & UIMSG_MOUSEIN_NEWWEARSLOT) || (dwMsg & UIMSG_MOUSEIN_ITEMSLOT);
