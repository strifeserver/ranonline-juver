...
void CCharacterCreatePageStyle::CreateSubControl ()
{
	...
	m_pCharScaleButtonLeft->SetVisibleSingle(FALSE);
	...
	m_pCharScaleButtonRight->SetVisibleSingle(FALSE);
	...
	m_pCharScaleStatic->SetVisibleSingle(FALSE);
	...
	m_pCharacterScaleBar->SetVisibleSingle(FALSE);
