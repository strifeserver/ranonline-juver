...
HRESULT CInnerInterface::InitDeviceObjects ( LPDIRECT3DDEVICEQ pd3dDevice )
{
	...
	// LG-7 AutoSystemWindow
	{
		...
		m_pAutoSystemWindow->CreateBaseWindowBlack("AUTOSYSTEM_WINDOW", (char*)ID2GAMEWORD("AUTO_SYSTEM_WINDOW") );
		...
		pButton->Create(AUTOSYSTEM_BUTTON, "AUTOSYSTEM_BUTTON", UI_FLAG_RIGHT | UI_FLAG_BOTTOM);
		pButton->CreateFlip("AUTOSYSTEM_BUTTON_F", CBasicButton::CLICK_FLIP);
		pButton->SetUseDynamic(TRUE);
		pButton->SetUseGlobalAction(TRUE);
		RegisterControl(pButton);
		ShowGroupBottom(AUTOSYSTEM_BUTTON);*/
	}
	/////////////////////////////////////////////////////////////////////////////
