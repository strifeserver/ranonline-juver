...
public:
	...
	void SetHairColor( DWORD dwColor )		{ m_dwColor1 = dwColor; m_bUseColor1 = TRUE; }
	DWORD GetHairColor() const				{ return m_dwColor1; }
	BOOL GetUseHairColor()	{ return m_bUseColor1; } 

	void SetColor1( DWORD dwColor )		{ m_dwColor1 = dwColor; m_bUseColor1 = TRUE; }
	void SetColor2( DWORD dwColor )		{ m_dwColor2 = dwColor; m_bUseColor2 = TRUE; }
	DWORD GetColor1()	{ return m_dwColor1; }
	DWORD GetColor2()	{ return m_dwColor2; }
	BOOL GetUseColor1()	{ return m_bUseColor1; } 
	BOOL GetUseColor2()	{ return m_bUseColor2; } 
