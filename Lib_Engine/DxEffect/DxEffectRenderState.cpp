...
void DxEffectRenderState::SetProperty ( PBYTE &pProp, DWORD &dwSize, DWORD dwVer )
{
	...
	{
		CDebugSet::ErrorVersion( "DxEffectRenderState::SetProperty", dwVer );
	}
}
...
void DxEffectRenderState::LoadBufferSet ( CSerialFile &SFile, DWORD dwVer, LPDIRECT3DDEVICEQ pd3dDevice )
{
	...
	{
		CDebugSet::ErrorVersion( "DxEffectRenderState::LoadBufferSet", SFile.GetFileName(), dwVer );
		DWORD dwBuffSize;
		SFile >> dwBuffSize;
...
void DxEffectRenderState::LoadBuffer ( CSerialFile &SFile, DWORD dwVer, LPDIRECT3DDEVICEQ pd3dDevice )
{
	...
	{
		CDebugSet::ErrorVersion( "DxEffectRenderState::LoadBuffer", SFile.GetFileName(), dwVer );
		DWORD dwBuffSize;
		SFile >> dwBuffSize;
