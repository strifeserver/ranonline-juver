...
void DxPieceAABB::Load_EP9( LPDIRECT3DDEVICEQ pd3dDevice, CSerialFile& SFile, const char* pPieceName )
{
	...
	{
		//jdevtodo
		//some data here with lightmaps looks like static mesh could be holding more tiles data
...
void DxPieceManager::LoadWLD_EP9( LPDIRECT3DDEVICEQ pd3dDevice, CSerialFile& SFile )
{
	...
	{
		CDebugSet::ErrorVersion( "DxPieceManager::LoadWLD_EP9", SFile.GetFileName(), dwVER );
		DWORD dwCur = SFile.GetfTell ();
